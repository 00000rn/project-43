...
// add code for displaying rest of the names and the hints.
    ...
    fill("white")
    textSize(15)
    text("A T A D A S B A", 100,50)
    fill("lightblue")
    text("Hint: Stores all information !!", 100,70)
// add code for displaying rest of the names and the hints.
...
fill("white")
    textSize(15)
    text("C U T N I F O N", 100,50)
    fill("lightblue")
    text("Hint: Performs a particular task !!", 100,70)
// add code for displaying rest of the names and the hints.
